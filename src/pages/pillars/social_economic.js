        ...
        <div>
          <ul>
            <li className='list_item'>
              <h6 style={{ fontWeight: 'bold', color: 'blue' }}>Agribusiness.</h6>
            ...
            <li className='list_item'>
              <h6 style={{ fontWeight: 'bold', color: 'blue' }}>Governance & Advocacy.</h6>
            ...
            <li className='list_item'>
              <h6 style={{ fontWeight: 'bold', color: 'blue' }}>Disaster and grief relief.</h6>
            ...
            <li className='list_item'>
              <h6 style={{ fontWeight: 'bold', color: 'blue' }}>Gifting to the elderly and needy.</h6>
